...
const retailDemandNodes: Node<BayesNodeData>[] = [
  ...
  },
  {
    ...
    data: {
      ...
      plate: 'obs',
      observed: true,
      observationProcess: { kind: 'missing', mechanism: 'unspecified', strategy: 'latent_imputation' },
    },
  },
  {
    id: 'channel_alpha',
...
const unevenBinomialNodes: Node<BayesNodeData>[] = [
  ...
  },
  {
    ...
    data: {
      ...
      plate: 'obs',
      observed: true,
      observationProcess: { kind: 'missing', mechanism: 'unspecified', strategy: 'note_only' },
...
const censoredAssayNodes: Node<BayesNodeData>[] = [
  ...
  },
  {
    ...
    data: {
      ...
      observationProcess: { kind: 'censored', direction: 'left', upper: 'lod[i]' },
